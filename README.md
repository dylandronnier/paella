# 🥘 Paella
*A modern JAX-based pipeline for training and deploying machine learning models.*

**Paella** demonstrates how to build a modern machine learning pipeline using the [`jax-ai-stack`](https://github.com/.../jax-ai-stack).  
It serves as a practical example of how to train and deploy ML models efficiently with JAX-based tools.
